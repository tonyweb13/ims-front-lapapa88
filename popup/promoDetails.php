...
<div id="popup-promos" ng-class="promoDetailsPopup()" ng-init="setPromoTab(promoDetailsTab);">
    <div class="popup-tabs">
        <ul class="popTabs">
            <li ng-class="{ active:isSetPromo(1) }" ng-click="setTabPromo(1)"></li>
            <li ng-class="{ active:isSetPromo(2) }" ng-click="setTabPromo(2)"></li>
            <li ng-class="{ active:isSetPromo(3) }" ng-click="setTabPromo(3)"></li>
            <li ng-class="{ active:isSetPromo(4) }" ng-click="setTabPromo(4)"></li>
            <li ng-class="{ active:isSetPromo(5) }" ng-click="setTabPromo(5)"></li>
            <li ng-class="{ active:isSetPromo(6) }" ng-click="setTabPromo(6)"></li>
        </ul>
        <div class="clear"></div>
        <div ng-show="isSetPromo(1)" class="popup-content">
            <div class="promo-details-img">
                <div class="promo-img" style="padding: 64px 0;">
                    ...
                    <p><span ng-bind="'This promotion will be start on' | translate"></span> 15 Aug – 15 Oct 2015 (<span ng-bind="'Sports' | translate"></span> <span ng-bind="'only' | translate"></span>)</p>
                    <button ng-show="!loggedIn" type="button" class="btn btn-join" ng-click="displaySignUp()" ng-bind="'Join Now' | translate"></button>
                </div>
            </div>
        ...
        <div ng-show="isSetPromo(2)" class="popup-content">
            <div class="promo-details-img">
                <div class="promo-img">
        ...
        <div ng-show="isSetPromo(3)" class="popup-content">
            <div class="promo-details-img">
                <div class="promo-img">
        ...
        <div ng-show="isSetPromo(4)" class="popup-content">
            <div class="promo-details-img">
                <div class="promo-img">
        ...
        <div ng-show="isSetPromo(5)" class="popup-content">
            <div class="promo-details-img">
                <div class="promo-img">
        ...
        <div ng-show="isSetPromo(6)" class="popup-content">
            <div class="promo-details-img">
                <div class="promo-img">
